...
st.set_page_config(page_title = "Car Price Prediction", page_icon = None, layout = "centered", initial_sidebar_state = "auto")
...
import plots
import predict
pages_dict = {"Home":home, "View Data":data, "Visualized Data":plots, "Predict":predict}
